...
echo ""
echo "Compare content of Rocky and EPEL"
echo "Rocky        python $ss_p rust $ss_r go $ss_g perl $ss_e ruby $ss_u total $ss"
echo "Rocky + EPEL python $ep_p rust $ep_r go $ep_g perl $ep_e ruby $ep_u total $ep"
